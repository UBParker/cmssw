// TripletProcessord: this class forms tracklets (pairs of stubs) w/o beamspot constraint for the displaced (extended) tracking.
// Triplet seeds are formed in the TripletEngine from these (=TripletProcessor) + a third stub.
#ifndef L1Trigger_TrackFindingTracklet_interface_TripletProcessor_h
#define L1Trigger_TrackFindingTracklet_interface_TripletProcessor_h
...
namespace trklet {
  ...
  class TripletProcessor : public ProcessBase {
  public:
    TripletProcessor(std::string name, Settings const& settings, Globals* global, unsigned int iSector);

    ~TripletProcessor() override;
